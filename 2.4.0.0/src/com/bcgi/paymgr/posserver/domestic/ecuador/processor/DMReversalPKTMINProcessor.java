...
public class DMReversalPKTMINProcessor  extends DMBaseMessageProcessor{
	static org.apache.log4j.Logger logger	= org.apache.log4j.Logger.getLogger(DMReversalPKTMINProcessor.class);

	public DMReversalPKTMINProcessor()
	{
...
/*	public POSGWMessageDTO unpackFromServerDTO(TransDetDTO reqTransDetDTO, boolean isPin)
    ...
    public TransDetDTO packToServerDTO(POSGWMessageDTO posGWMessageDTO)
    {
    	...
    	transDetDTO.setTransactionCode(DataUtil.getTranscode(posGWAccountRechargeDTO.getProcessingCode())[0]);
	...
	public POSGWMessageDTO unpackISOMsg(ISOMsg requestISOMsg,POSGWMessageDTO posGWMessageDTO)
	{
		...
		try
		{
           ...
           // String overrideFraudId = "off";
			...
			// newly added packetCode  48th field 
