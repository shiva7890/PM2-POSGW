...
import com.bcgi.paymgr.posserver.domestic.ecuador.processor.coupon.DMRechargeCouponRedemption;
import com.bcgi.paymgr.posserver.domestic.ecuador.validator.DMReqMsgDataValidator;



public class DMCouponRechargeValidator {
	static org.apache.log4j.Logger logger	= org.apache.log4j.Logger.getLogger(DMCouponRechargeValidator.class);
	...
	private static String isValidData(POSGWAccountRechargeDTO posGWAccountRechargeDTO)
	{
    	...
    	//Coupon Number
	    	...
	    	String couponNumber = posGWAccountRechargeDTO.getPinNumber();
	    		...
	    		if (!status.equals(ResponseCodeConstant.INTERNAL_SUCCESS_STATUS))
	    		{
    			logger.debug("coupon pindata is missing..."+status);
	    			return status;
	    		}
