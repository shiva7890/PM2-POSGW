...
import com.bcgi.paymgr.posserver.domestic.ecuador.validator.DMASyncPKTRechargeMINValidator;
...
public class DMASyncPKTRechargeMINProcessor extends DMBaseMessageProcessor
{
	static org.apache.log4j.Logger logger	= org.apache.log4j.Logger.getLogger(DMASyncPKTRechargeMINProcessor.class);

	public DMASyncPKTRechargeMINProcessor()
	{
	...
	public String isValidMessage(POSGWMessageDTO posGWMessageDTO)
	{
		...
		if (posGWMessageDTO != null)
		{
			...
			status = DMASyncPKTRechargeMINValidator.isValidReqData(posGWAccountRechargeDTO);
		}
		/*else
		{
