...
public class DMUnifiedASyncRechargePKTMINValidator {
...
//	      Transaction Amount
	    	...
	    	System.out.println("packetCode :::::>>>>>"+packetCode);
	    	 if(packetCode!= null  &&  packetCode.trim().length()>0){
	    		 ...
	    		 if(DMMessageTypeIDConstant.UNIFIED_ASYNC_MIN_PKT_RECHARGE_PROCESSING_CODE_ID_TUENTI.equals(posGWAccountRechargeDTO.getProcessingCode())||DMMessageTypeIDConstant.UNIFIED_ASYNC_MIN_PKT_RECHARGE_PROCESSING_CODE_ID.equals(posGWAccountRechargeDTO.getProcessingCode())||DMMessageTypeIDConstant.SYNC_MIN_PKT_RECHARGE_PROCESSING_CODE_ID.equals(posGWAccountRechargeDTO.getProcessingCode())
