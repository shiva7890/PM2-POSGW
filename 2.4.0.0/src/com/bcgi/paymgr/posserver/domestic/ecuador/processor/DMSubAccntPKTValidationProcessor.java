...
import com.bcgi.paymgr.posserver.domestic.ecuador.validator.DMSubAccntPKTValidator;
...
public class DMSubAccntPKTValidationProcessor extends DMBaseMessageProcessor
{
	static org.apache.log4j.Logger logger	= org.apache.log4j.Logger.getLogger(DMSubAccntPKTValidationProcessor.class);

	public DMSubAccntPKTValidationProcessor()
	{
	...
	public String isValidMessage(POSGWMessageDTO posGWMessageDTO)
	{
		...
		if (posGWMessageDTO != null)
		{
			...
			status = DMSubAccntPKTValidator.isValidReqData(posGWAccountRechargeDTO);
		}
		/*else
		{
    ...
    public OrderRequestDTO packToServerDTO(POSGWMessageDTO posGWMessageDTO)
    {
        ...
        logger.info(" PacketCode::: ==>"+orderRequestDTO.getPacketCode());
        String transAmt = posGWAccountRechargeDTO.getTransactionAmount();
