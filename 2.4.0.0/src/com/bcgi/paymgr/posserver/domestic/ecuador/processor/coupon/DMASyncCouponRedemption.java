...
import com.bcgi.paymgr.posserver.domestic.ecuador.constant.DMISOMessageFieldIDConstant;
import com.bcgi.paymgr.posserver.domestic.ecuador.validator.coupon.DMASyncCouponRedeemptionValidator;
...
public class DMASyncCouponRedemption extends DMBaseMessageProcessor
{
	static org.apache.log4j.Logger logger	= org.apache.log4j.Logger.getLogger(DMASyncCouponRedemption.class);

	public DMASyncCouponRedemption()
	{
	...
	public String isValidMessage(POSGWMessageDTO posGWMessageDTO)
	{
		...
		if (posGWMessageDTO != null)
		{
			...
			status = DMASyncCouponRedeemptionValidator.isValidReqData(posGWAccountRechargeDTO);
		}
	...
	public POSGWMessageDTO processMessage(POSGWMessageDTO reqPOSGWMessageDTO)
	{
		...
		try
		{
			...
			orderResponseDTO = dmTransactionDelegate.processASyncCouponRedemption(orderRequestDTO);
			...
			if (posMessageDTO != null)
			{
			    ...
			    if (responseCode != null)
			    {
			    	if (responseCode.equals(ResponseCodeConstant.SUCCESS))
			    	{
			    		...
			    		requestISOMsg.set(DMISOMessageFieldIDConstant.REDEEMPTION_ID,String.valueOf(posGWAccountRechargeDTO.getCouponRedeemTransId()));
			    	}
	...
	public ISOMsg execute(ISOMsg requestISOMsg,POSGWMessageDTO posGWMessageDTO){
		...
		logger.info("DMASyncCouponRedemption Processor - execute()........");
