...
import com.bcgi.paymgr.posserver.domestic.ecuador.validator.coupon.DMRechargeCouponInquiryValidator;
...
public class DMRechargeCouponInquiryProcessor extends DMBaseMessageProcessor
{
	static org.apache.log4j.Logger logger	= org.apache.log4j.Logger.getLogger(DMRechargeCouponInquiryProcessor.class);

	public DMRechargeCouponInquiryProcessor()
	{
	...
	public String isValidMessage(POSGWMessageDTO posGWMessageDTO)
	{
		...
		if (posGWMessageDTO != null)
		{
			...
			status = DMRechargeCouponInquiryValidator.isValidReqData(posGWAccountRechargeDTO);
		}
		/*else
		{
	...
	public POSGWMessageDTO processMessage(POSGWMessageDTO reqPOSGWMessageDTO)
	{
		...
		try
		{
			...
			//DMTransactionDelegate dmTransactionDelegate = new DMTransactionDelegate(ServerConfigConstant.RR_ASYNCHRONOUS_CALL);
			DMTransactionDelegate rechargeDelegate = new DMTransactionDelegate(ServerConfigConstant.RR_ASYNCHRONOUS_CALL, "");
			orderResponseDTO = rechargeDelegate.processRechargeCouponInquiry(orderRequestDTO);
	 ...
	 public RejectTransactionDTO packToServerRejectTransDTO(POSGWMessageDTO posGWMessageDTO)
	    {
	    	...
	    	//transDetDTO.setMvneId(posGWAccountRechargeDTO.getMvneId());
    ...
    public OrderRequestDTO packToServerDTO(POSGWMessageDTO posGWMessageDTO)
    {
        ...
        // End <--
       // orderRequestDTO.setMvneId(posGWAccountRechargeDTO.getMvneId());
	...
	public POSGWMessageDTO unpackISOMsg(ISOMsg requestISOMsg,POSGWMessageDTO posGWMessageDTO)
	{
		...
		try
		{
           ...
           // posGWAccountRechargeDTO.setMvneId(DataUtil.getMappedOperatorId(processingCode));
