...
public class LRCRechargeMINProcessor extends DMBaseMessageProcessor
{
	
	
	static Logger logger	= Logger.getLogger(LRCRechargeMINProcessor.class);
	private String connectionId=null;

	public LRCRechargeMINProcessor()
	{
