...
public class IRCommandMap {

	  private Map processorMap = new HashMap();
	  private static IRCommandMap mapInstance;

	  public synchronized static IRCommandMap getInstance(int msgFormat) {
	    if (mapInstance == null) {
	    	mapInstance = new IRCommandMap(msgFormat);
	    }
	    return mapInstance;
	  }
	  ...
	  private IRCommandMap(int msgFormat) {
		  ...
		  switch (msgFormat) 
			{
					...
					case MessageFormatConstant.IRP_MESSAGE_FORMAT_ID:
					{
					      ...
					      processorMap.put ( IRPProcessorConstant.IRP_ASYNC_RECHARGE_UNIFIED_PROCESSOR_ID, IRPProcessorConstant.IRP_RECHARGE_MIN_PROCESSOR_CLASS_NAME);
					      processorMap.put ( IRPProcessorConstant.IRP_SYNC_RECHARGE_VALIDATOR_PROCESSOR_ID, IRPProcessorConstant.IRP_RECHARGE_MIN_PROCESSOR_CLASS_NAME);
					      processorMap.put ( IRPProcessorConstant.IRP_ASYNC_RECHARGE_PROCESSOR_ID, IRPProcessorConstant.IRP_RECHARGE_MIN_PROCESSOR_CLASS_NAME);
					      processorMap.put ( IRPProcessorConstant.IRP_ASYNC_REVERSAL_PROCESSOR_ID, IRPProcessorConstant.IRP_MIN_REVERSAL_PROCESSOR_CLASS_NAME);
					      processorMap.put ( IRPProcessorConstant.IRP_ASYNC_RECHARGE_INQUIRY_ID, IRPProcessorConstant.IRP_RECHARGE_MIN_PROCESSOR_CLASS_NAME);
					      processorMap.put ( IRPProcessorConstant.IRP_ASYNC_REVERSAL_INQUIRY_ID, IRPProcessorConstant.IRP_RECHARGE_MIN_PROCESSOR_CLASS_NAME);
					      break;
					}
			}
